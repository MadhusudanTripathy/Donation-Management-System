...
%>
                <div class="table-row">
                    ...
                    <div class="table-cell">
                        <p><%=resultSet.getString("donee_name")%></p>
                    </div>
                    <div class="table-cell">
                    ...
                    <div class="table-cell">
                        <p><%=resultSet.getString("target_amount")%></p>
                    </div>
                    <div class="table-cell">
                        <a class="btn btn-warning btn-lg btn-block" href="edit?id=<%=resultSet.getString("id")%>">Edit</a>
                    </div>
                    <div class="table-cell">
                        <a class="btn btn-warning btn-lg btn-block" href="delete?id=<%=resultSet.getString("id")%>">Delete</a>
                    </div>
                </div>
                <% 
}
