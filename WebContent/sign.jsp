...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="register" method="post" enctype="multipart/form-data">
			...
			<input name="uphone" type="tel" required="required" placeholder="Phone Number" />
			<input name="udob" type="date" required="required" />
			<input name="uimg" type="file" required="required" />
...
<script>
	...
	if(status=="failed")swal("Authentication Failed", "Something Went Wrong", "error");
